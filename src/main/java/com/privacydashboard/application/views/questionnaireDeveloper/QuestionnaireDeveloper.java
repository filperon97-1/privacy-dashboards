...
public class QuestionnaireDeveloper extends AppLayout {
    ...
    public QuestionnaireDeveloper(){
        ...
        tabs.addSelectedChangeListener(e-> changeTab(e));
        content.add(sections[0]);
    ...
    private void section1(){
        ...
        titles[k]= new Div(new Span("Does the app transfer data to a third party?"), icons[0]);
        contextMenus[k].addItem(createInfo("GDPR Article 13", "Where personal data relating to a data subject are collected from the data subject, the controller shall, at the time when personal data are obtained, provide the data subject with... the fact that the controller intends to transfer personal data to a third country or international organisation"));
        radioGroups[k]= new RadioButtonGroup<>();
        radioGroups[k].setItems("No", "Yes, only in United Europe", "Yes, also outside United Europe", "I don't know");
        textAreas[k]= new TextArea("List which third countries, if any");
        k++;

        //Domanda 2: Periodo mantenimento dei dati
        titles[k]= new Div(new Span("For how long are the data going to be stored?"), icons[1]);
        contextMenus[k].addItem(createInfo("GDPR Article 13", "the controller shall, at the time when personal data are obtained, provide the data subject with the following further information... the period for which the personal data will be stored"));
        radioGroups[k]= new RadioButtonGroup<>();
        radioGroups[k].setItems("less than 1 month", "between 1 month and 6 months", "between 6 months and 2 years", "more than 2 years", "I don't know");
        k++;

        //Domanda 3: Esistenza processo decisionale automatizzato
        titles[k]= new Div(new Span("Is there an automated decision-making, including profiling?"), icons[2]);
        contextMenus[k].addItem(createInfo("GDPR Article 13", "the controller shall, at the time when personal data are obtained, provide the data subject with the following further information... the existence of automated decision-making, including profiling"));
        radioGroups[k]= new RadioButtonGroup<>();
